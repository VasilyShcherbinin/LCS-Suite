...
from UCS.UCS_Classifier import Classifier
...
class ClassifierSet:
    ...
    # --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    def makeMatchSet(self, phenotype, exploreIter):
    ...
    def runGA(self, exploreIter, state, phenotype):
        """ The genetic discovery mechanism in LCS is controlled here. """
        # -------------------------------------------------------
        # GA RUN REQUIREMENT
        # -------------------------------------------------------
        if (
    ...
    def insertDiscoveredClassifiers(self, cl1, cl2, clP1, clP2, exploreIter):
        ...
        prevents such rules from being added to the population, as it offers no predictive value within LCS. """
        # -------------------------------------------------------
        # SUBSUMPTION
        # -------------------------------------------------------
    ...
    def updateParams(self, exploreIter):
